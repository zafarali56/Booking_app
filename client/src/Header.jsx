...
export default function Header() {
  ...
  return (
    <header className="flex bg-white gap-1 md:flex-row sm:flex-row lg:flex-row flex-row items-center justify-between">
      ...
      <div className="flex border border-gray-300 rounded-full py-1 shadow shadow-gray-500 items-center shadow-grey-300 ">
      ...
      <Link
        ...
        className="flex gap-2  border border-gray-300 rounded-full py-2 p-3 shadow-md items-center shadow-grey-300"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
          fill="currentColor"
          className="w-6 h-6 custom-hidden"
        >
          <path
            fillRule="evenodd"
